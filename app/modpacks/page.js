...
export const metadata = {
  title: 'Модпаки для Minecraft - Скачать бесплатно | White Minecraft',
              ...
              >
                <div className="flex items-center gap-3 w-full sm:w-auto">
                  ...
                  <div className="flex-1 min-w-0 sm:hidden">
                    <h3 className="text-lg font-bold mb-1 line-clamp-1">{modpack.title}</h3>
                    <div className="flex items-center gap-2 text-xs">
                      <span className="text-gray-400">📥 {formatDownloads(modpack.downloads)}</span>
                      <span className="text-gray-400">❤️ {formatDownloads(modpack.follows)}</span>
                    </div>
                  </div>
                </div>
                
                <div className="flex-1 min-w-0 w-full sm:w-auto hidden sm:block">
                  <h3 className="text-lg md:text-xl font-bold mb-1">{modpack.title}</h3>
                  ...
                  <div className="flex items-center gap-2 text-sm flex-wrap">
                    ...
                    <span className="text-gray-400 flex items-center gap-1">
                      ❤️ {formatDownloads(modpack.follows)}
                    </span>
