                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                  ...
                  <div className="flex-1 min-w-0 sm:hidden">
                    ...
                    <div className="flex items-center gap-2 text-xs">
                      <span className="text-gray-400">📥 {formatDownloads(mod.downloads)}</span>
                      <span className="text-gray-400">❤️ {formatDownloads(mod.follows)}</span>
                    </div>
                  </div>
                </div>
                
                <div className="flex-1 min-w-0 w-full sm:w-auto hidden sm:block">
                  <h3 className="text-lg md:text-xl font-bold mb-1">{mod.title}</h3>
